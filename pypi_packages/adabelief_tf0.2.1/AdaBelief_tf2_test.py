...
def test_scheduler_serialization():
    ...
    assert new_optimizer.get_config()["learning_rate"]["class_name"] == "ExponentialDecay"
    assert new_optimizer.get_config()["learning_rate"]["config"] == lr_scheduler.get_config()

    assert new_optimizer.get_config()["weight_decay"]["class_name"] == "InverseTimeDecay"
    assert new_optimizer.get_config()["weight_decay"]["config"] == wd_scheduler.get_config()
